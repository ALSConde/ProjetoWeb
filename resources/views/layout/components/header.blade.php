        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown"
            ...
            <ul class="app-notification dropdown-menu dropdown-menu-right">
                ...
                <div class="app-notification__content">
                    <li><a class="app-notification_item" href="javascript:;"><span class="app-notification_icon"><span
                    ...
                    <div class="app-notification__content">
                        <li><a class="app-notification_item" href="javascript:;"><span
                                    class="app-notification_icon"><span class="fa-stack fa-lg"><i
